...
\newcommand{\titlePersonalInfo}[6]{
  ...
  $\cdotp$\hspace{0.4em}\href{mailto:#3}{#3}\hspace{0.4em}
  $\cdotp$\hspace{0.4em}\href{http://#4}{#4}\hspace{0.4em}
...
\begin{document}
  ...
  \titlePersonalInfo{Harsh Tiwari}{(+91) 7355517759}{h.tiwari.dev@gmail.com}{tiwariaiharsh.com}
